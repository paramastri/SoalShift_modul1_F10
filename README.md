...
c. Pada Soal point B output product line nya adalah "Personal Accessories, Camping Equipment, dan Outdoor Protection” jadi mengunakan codingan yg mirip dengan penambahan kondisi pada if (“ awk -F "," '{if($1 == "United States" && $7 == '2012' && $4 == "Personal Accessories") iter[$6]+=$10} “) serta mengambil 3 kolom terakhir, dimana itu adalah nama record dari Product yang memiliki maksimal 3 kata (“ | awk 'NR <=3 {print $2, $3, $4} “).
